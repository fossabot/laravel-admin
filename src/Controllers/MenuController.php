        ...
        return $content
            ...
            ->row(function (Row $row) {
                ...
                $row->column(6, function (Column $column) {
                    ...
                    $form->icon('icon', trans('admin.icon'))->default('fas fa-bars fa-fw')->rules('required')->help($this->iconHelp());
    ...
    protected function treeView()
    {
        return Menu::tree(function (Tree $tree) {
            ...
            $tree->branch(function ($branch) {
                $payload = "<i class='{$branch['icon']} fa-fw'></i>&nbsp;<strong>{$branch['title']}</strong>";
